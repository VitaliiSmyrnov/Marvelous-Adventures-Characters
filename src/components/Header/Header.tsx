...
import { Logo, Search } from "src/components/Icons";
  ...
  return (
    <header className="absolute left-0 top-0 z-10 flex w-full items-center justify-between px-[20px] pt-[20px] md:px-[32px] md:pt-[24px]">
      ...
      <div className="relative">
        ...
        />
        <Search className="absolute left-[18px] top-[6px] h-4 w-4 fill-transparent stroke-current md:left-[24px] md:top-[13px]" />
      </div>
    </header>
  );
};
